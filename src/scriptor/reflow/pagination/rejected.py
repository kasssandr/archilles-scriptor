...
def _verdict_for(o, page, predicted: str | None, in_a_run: set[int],
    ...
    # -- ``printed-head`` included, which is a rescue too but out of the running
    # head, where no apparatus is -- and letting the apparatus claim it costs
    # the classification its best case: a chapter opening carries note 1, and
    # Gli Actus opens its chapters with a bare "2".
    value = ordinal_of(o.label)
